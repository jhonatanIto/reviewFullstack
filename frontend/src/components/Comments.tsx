...
const Comments = ({
  ...
  return (
    <div
      ...
      className={`flex flex-col items-center absolute md:w-95 md:right-22 md:h-178 md:mb-6 bg-white  rounded-2xl overflow-y-auto md:overflow-hidden shadow-black shadow-lg 
